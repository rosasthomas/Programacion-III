...
$app->delete('/', \Media::class . ':BorrarUno')->add(\MW::class . '::VerificarPropietario')->add(\MW::class . ':VerificarEncargado');
$app->put('/', \Media::class . ':ModificarUno')->add(\MW::class . '::VerificarPropietario')->add(\MW::class . ':VerificarEncargado');
...
$app->group('/ventas', function(){
    $this->post('[/]', \Venta::class . ':Vender');
    $this->get('[/]', \Venta::class . ':TraerTodos');
    $this->delete('[/]', \Venta::class . ':BorrarUno')->add(\MW::class . ':VerificarEmpleado');
    $this->put('[/]', \Venta::class . ':ModificarUno')->add(\MW::class . ':VerificarEmpleado');
});

$app->get('/listadoFotos[/]', \Usuario::class . ':Listado');
